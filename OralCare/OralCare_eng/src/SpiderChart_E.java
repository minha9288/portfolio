...
public class SpiderChart_E extends JPanel {
	...
	static float score_MouthHabit = 0;
        ...
        public SpiderChart_E(float s1, float s2, float s3, float s4, float s5) {
        ...
        private static CategoryDataset createDataset() {
                String graph = "Get Score";
                String element_TheethNum = "No. of tooth";
                String element_DentalCaries = "Caries state";
                String element_PeriodontalStatus = "Periodontal state";
                String element_OtherMouthStatus = "Other Oral state";
                String element_MouthHabit = "Dental Care ability/habits";
