...
class Menu extends JFrame {
	...
	public JPanel SearchTab() {
		...
		JButton newBtn = new JButton("새로작성");
		...
		JButton alreadyBtn = new JButton("불러오기");
...
//						2, 2, 2, 2), 0, 0));
	...
	public ScrollPane PatientInfo() {
		...
		JLabel Birth = new JLabel("생년월일 (년/월/일)  ");
		YF = new JTextField(6);
		MF = new JTextField(6);
		DF = new JTextField(6);
	...
	public void saveToExcel(String filePath){
	        ...
	        try{
	            ...
	            label = new Label(0, 0, "차트번호");
	            sheet.addCell(label);
	            
	            label = new Label(1, 0, "이름");
	            sheet.addCell(label);
	            
	            label = new Label(2, 0, "나이");
	            sheet.addCell(label);
	            
	            label = new Label(3, 0, "성별");
	            sheet.addCell(label);
	            
	            label = new Label(4, 0, "유치개수");
	            sheet.addCell(label);
	            
	            label = new Label(5, 0, "영구치개수");
	            sheet.addCell(label);
	            
	            label = new Label(6, 0, "앞니 상실치아 개수");
	            sheet.addCell(label);
	            
	            label = new Label(7, 0, "어금니 상실치아 개수");
	            sheet.addCell(label);
	            
	            label = new Label(8, 0, "인공치아 개수");
	            sheet.addCell(label);
	            
	            label = new Label(9, 0, "틀니 개수");
	            sheet.addCell(label);
	            
	            label = new Label(10, 0, "우식방치치아 개수");
	            sheet.addCell(label);
	            
	            label = new Label(11, 0, "충전치아 개수");
	            sheet.addCell(label);
	            
	            label = new Label(12, 0, "깊은 열구 치아 개수");
	            sheet.addCell(label);
	            
	            label = new Label(13, 0, "치면세균막 지수");
	            sheet.addCell(label);
	            
	            label = new Label(14, 0, "치석");
	            sheet.addCell(label);
	            
	            label = new Label(15, 0, "치은염");
	            sheet.addCell(label);
	            
	            label = new Label(16, 0, "살사균 양");
	            sheet.addCell(label);
	            
	            label = new Label(17, 0, "살사균 활동성");
	            sheet.addCell(label);
	            
	            label = new Label(18, 0, "구균 양");
	            sheet.addCell(label);
	            
	            label = new Label(19, 0, "구균 활동성");
	            sheet.addCell(label);
	            
	            label = new Label(20, 0, "스나이더 검사");
	            sheet.addCell(label);
	            
	            label = new Label(21, 0, "부정교합");
	            sheet.addCell(label);
	            
	            label = new Label(22, 0, "치아파절, 외상");
	            sheet.addCell(label);
	            
	            label = new Label(23, 0, "구강감염");
	            sheet.addCell(label);
	            
	            label = new Label(24, 0, "구취");
	            sheet.addCell(label);

	            label = new Label(25, 0, "이닦기 방법");
	            sheet.addCell(label);

	            label = new Label(26, 0, "치주낭");
	            sheet.addCell(label);

	            label = new Label(27, 0, "치아동요");
	            sheet.addCell(label);

	            label = new Label(28, 0, "약관절 이상");
	            sheet.addCell(label);

	            label = new Label(29, 0, "심미요인");
	            sheet.addCell(label);

	            label = new Label(30, 0, "타액 양");
	            sheet.addCell(label);

	            label = new Label(31, 0, "점조도");
	            sheet.addCell(label);

	            label = new Label(32, 0, "사랑니 통증");
	            sheet.addCell(label);

	            label = new Label(33, 0, "시린니");
	            sheet.addCell(label);

	            label = new Label(34, 0, "국소의치 장착여부");
	            sheet.addCell(label);

	            label = new Label(35, 0, "보철물, 의치 필요");
	            sheet.addCell(label);

	            label = new Label(36, 0, "틀니 필요도");
	            sheet.addCell(label);

	            label = new Label(37, 0, "당섭취");
	            sheet.addCell(label);

	            label = new Label(38, 0, "이닦은 횟수");
	            sheet.addCell(label);

	            label = new Label(39, 0, "치아저작 기능");
	            sheet.addCell(label);

	            label = new Label(40, 0, "이닦기 시기");
	            sheet.addCell(label);

	            label = new Label(41, 0, "전신질환 개수");
	            sheet.addCell(label);

	            label = new Label(42, 0, "전신질환 종류");
	            sheet.addCell(label);

	            label = new Label(43, 0, "예방진료 여부");
	            sheet.addCell(label);

	            label = new Label(44, 0, "치과방문 경험");
	            sheet.addCell(label);

	            label = new Label(45, 0, "스케일링 경험");
	            sheet.addCell(label);

	            label = new Label(46, 0, "구강용품사용");
	            sheet.addCell(label);

	            label = new Label(47, 0, "음주여부");
	            sheet.addCell(label);

	            label = new Label(48, 0, "흡연여부");
	            sheet.addCell(label);

	            label = new Label(49, 0, "음주&흡연");
	            sheet.addCell(label);

	            label = new Label(50, 0, "구강건조증");
	            sheet.addCell(label);

	            label = new Label(51, 0, "보건교육 여부");
	            sheet.addCell(label);

	            label = new Label(52, 0, "임신여부");
	            sheet.addCell(label);
