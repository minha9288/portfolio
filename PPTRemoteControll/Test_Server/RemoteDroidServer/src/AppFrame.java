...
public class AppFrame extends Frame {
        ...
        public AppFrame() {
                ...
                this.textLines[0] = "The MultiMouse server application is now running.";
                ...
                this.textLines[5] = "MultiMouse application on your phone to begin.";
        ...
        public void init() {
                ...
                try {
                		...
                		this.imLogo = this.getImage("/ServerUP.png");
                ...
                this.setBackground(new Color(46, 152, 251)); 
