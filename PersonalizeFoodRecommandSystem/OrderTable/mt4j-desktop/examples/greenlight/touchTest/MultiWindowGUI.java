...
import greenlight.touchTest.AppSetup;
import greenlight.touchTest.SimpleAppLauncher;
...
class InternalFrame_for_one_12 extends JInternalFrame {
    ...
    public InternalFrame_for_one_12(Dimension frameSize) {
		...
		final JButton button = new JButton("zz");
	...
	public InternalFrame_for_one_34(Dimension frameSize) {
		...
		button.addMouseListener(new MouseListener(){
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(arg0.getClickCount() == 2){
					button.setText("3-2번클릭");
					System.out.println("2-2번클릭");
				}else if(arg0.getClickCount() == 1){
					if(arg0.getClickCount() != 2)
						button.setText("3-2번클릭");
						System.out.println("2-1번클릭");
				}
	...
	public InternalFrame_for_two_12s_1(Dimension frameSize) {
		...
		button.addMouseListener(new MouseListener(){
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(arg0.getClickCount() == 2){
					button.setText("3-2번클릭");
					System.out.println("3-2번클릭");
				}else if(arg0.getClickCount() == 1){
					if(arg0.getClickCount() != 2)
						button.setText("3-2번클릭");
						System.out.println("3-1번클릭");
				}
