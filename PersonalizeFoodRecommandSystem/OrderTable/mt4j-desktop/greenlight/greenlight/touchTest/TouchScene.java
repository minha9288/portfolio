...
public class TouchScene extends AbstractScene {
	...
	public TouchScene(AbstractMTApplication mtAppl, String name) {
		...
		//Load from classpath
				...
				final MTImageButton keyboardButton = new MTImageButton(app, app.loadImage("C:\\HONG\\image1.jpg"));
				...
				keyboardButton.addGestureListener(TapProcessor.class, new IGestureEventListener() {
					...
					public boolean processGestureEvent(MTGestureEvent ge) {
						...
						case TapEvent.TAPPED:
							...
							final MTImageButton plusButton = new MTImageButton(app, app.loadImage("C:\\HONG\\Lighthouse.jpg"));
	...
	public TouchScene(AbstractMTApplication mtAppl, String name, 
		...
		RecommandAlgorithm rec = new RecommandAlgorithm();
		recMenuImgName = rec.getRecommandAlgorithmResult();
		
		for(int i=0; i<5; i++){
			//추천메뉴 4가지 이름 받아오기
			String imgName = "menu" + (i+1) + "";
			recMenuImgName.add(imgName);
		}
		
		//메뉴 4가지 해당 이미지 로딩
		menu1Img = new MTImageButton(app, app.loadImage("C:\\HONG\\OrderTable\\ImageFiles\\" + recMenuImgName.get(0) + ".jpg"));
		menu1Img.setName("menu1Img");
		menu1Img.setNoStroke(true);
		menu1Img.translateGlobal(new Vector3D(50, 200));
		topLayer.addChild(menu1Img);	
		final MTImageButton menu2Img = new MTImageButton(app, app.loadImage("C:\\HONG\\OrderTable\\ImageFiles\\" + recMenuImgName.get(1) + ".jpg"));
		...
		final MTImageButton menu3Img = new MTImageButton(app, app.loadImage("C:\\HONG\\OrderTable\\ImageFiles\\" + recMenuImgName.get(2) + ".jpg"));
		...
		final MTImageButton menu4Img = new MTImageButton(app, app.loadImage("C:\\HONG\\OrderTable\\ImageFiles\\" + recMenuImgName.get(3) + ".jpg"));
		...
		final MTImageButton nextBtn = new MTImageButton(app, app.loadImage("C:\\HONG\\OrderTable\\ImageFiles\\" + "nextBtn.jpg"));
		nextBtn.setName("nextBtn");
		nextBtn.setNoStroke(true);
		nextBtn.translateGlobal(new Vector3D(1000, 500));
		topLayer.addChild(nextBtn);
